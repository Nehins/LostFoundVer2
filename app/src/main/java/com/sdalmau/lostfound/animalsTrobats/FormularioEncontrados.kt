...
import com.sdalmau.lostfound.databinding.FragmentFormularioEncontradosBinding
...
class formularioEncontrados : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.guardarInformacio.setOnClickListener{
            ...
            if(color.isNotBlank() && llocTrobat.isNotBlank() && descripcio.isNotBlank() && filePath!=null){
